...
from leetcode.rising_temperature_generators import rising_temperature_generators


def test_rising_temperature_generators_example():
    weather = [
    ...
    result = rising_temperature_generators(weather)
    assert sorted(result) == [2, 4]


def test_rising_temperature_generators_no_rise():
    weather = [
    ...
    assert rising_temperature_generators(weather) == []


def test_rising_temperature_generators_single_entry():
    weather = [
...
def test_rising_temperature_generators_unordered_input():
    weather = [
    ...
    assert rising_temperature_generators(weather) == [2, 3]
