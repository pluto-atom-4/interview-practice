...
from leetcode.range_sum_query_mutable_generators import NumArrayGenerators


def test_basic_operations():
    arr = NumArrayGenerators([1, 3, 5])
...
def test_multiple_updates():
    arr = NumArrayGenerators([2, 4, 6, 8, 10])
...
def test_edge_ranges():
    arr = NumArrayGenerators([5, -2, 7, 3])
